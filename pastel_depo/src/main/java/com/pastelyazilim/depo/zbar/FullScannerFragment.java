...
public class FullScannerFragment extends Fragment implements MessageDialogFragment.MessageDialogListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state) {
        mScannerView = new ZBarScannerView(getActivity().getApplicationContext());
    ...
    public void handleResult(Result rawResult) {
        ...
        showMessageDialog( rawResult.getContents() , rawResult.getBarcodeFormat().getName());
    }

    public void showMessageDialog(String barkod, String barkodTuru) {


        getActivity().getIntent().putExtra("barkodDegeri", barkod);
        getActivity().setResult(RESULT_OK, getActivity().getIntent());
        getActivity().finish();

        //String message="Okunan Barkod Değeri= " + barkod + "\nBarkod Türü = " + barkodTuru;
        //DialogFragment fragment = MessageDialogFragment.newInstance("Barkod Okuma Sonucu", message, this);
